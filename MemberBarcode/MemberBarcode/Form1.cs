...
namespace MemberBarcode
{
    public partial class Form1 : Form
    {
        ...
        public Form1(Form2 form2, string memberId, Crud crud, DuplicatedFunction duplicatedFunction, SqlQuery sqlQuery)
        {
            ...
            this.textBoxes = new TextBox[] { textBoxName, textBoxDate, textBoxInfo1, textBoxInfo2, textBoxInfo3 };
            this.TextBoxesBarcode = new TextBox[] { textBoxName, textBoxDate, textBoxInfo1, textBoxInfo2, textBoxInfo3 };
