...
namespace MemberBarcode
{
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            //db연결 경로 조정할 것
            string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\2klab\OneDrive\2kd\Projects_c#\MemberBarcode_3\DatabaseMemberBarcode.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        {
            string queryRead = sqlQuery.SelectAllFrom_Where_("MEMBER", "ID", new string[] { textBoxId.Text });
        ...
        private void buttonCreatePanelCreate_Click(object sender, EventArgs e)
        {
            ...
            string[] values = { textBoxCreateId.Text };
            //read는 중복체크할 경우 필요, 현재 중복체크가 따로 떨여저서 필요없음
            string qeuryRead = sqlQuery.SelectAllFrom_Where_("MEMBER", "ID", values);
